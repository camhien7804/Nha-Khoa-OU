...
export default function MainNav({ shrink = false }) {
  ...
  const servicesList = [
    { slug: "trong-rang-implant", label: t("Trồng răng Implant") },
    { slug: "nieng-rang", label: t("Niềng răng") },
    { slug: "nha-khoa-tong-quat", label: t("Nha khoa tổng quát") },
    { slug: "nha-khoa-tre-em", label: t("Nha khoa trẻ em") },
  ];
