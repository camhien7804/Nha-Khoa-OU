...
export default function ServiceCategory() {
  ...
  const title = t(CATEGORY_NAMES[category] || category || "Dịch vụ");
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <Breadcrumb
          items={[
            ...
            { label: t("Dịch vụ"), to: "/dich-vu/trong-rang-implant" },
            { label: title },
          ]}
        />
      ...
      {loading ? (
        ...
        <div>{t("Chưa có dịch vụ trong danh mục này.")}</div>
      ) : (
